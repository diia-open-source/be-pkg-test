...
This repository contains the package with test utils.
...
In order to install and use the linked dependencies for `pkg-test` the following command can be used:
